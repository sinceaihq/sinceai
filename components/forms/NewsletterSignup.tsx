      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col sm:flex-row gap-3">
          <input
            ...
            className="flex-1 px-5 py-3 rounded-none bg-white/5 border border-white/10 text-white placeholder-neutral-500 focus:outline-none focus:border-white/30 disabled:opacity-50 text-sm"
          />
          <button
            type="submit"
            disabled={isSubmitting}
