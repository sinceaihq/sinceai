    ...
    <section className="relative flex flex-col bg-black" style={{ paddingLeft: "var(--space-lg)", paddingRight: "var(--space-lg)" }}>
      ...
      >
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <Link
              href="/hackathon"
              className="inline-block font-mono text-[13px] font-bold text-black bg-white px-5 py-3 border border-white whitespace-nowrap transition-colors duration-300 hover:bg-neutral-100"
            >
              Learn more →
            </Link>
            {/* Secondary — outlined */}
            <Link
              href="/partners"
              className="inline-block font-mono text-[13px] font-bold text-white bg-transparent px-5 py-3 border border-white/20 whitespace-nowrap transition-colors duration-300 hover:border-white"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 font-mono text-[13px] font-bold text-white bg-transparent px-5 py-3 border border-white/20 whitespace-nowrap transition-colors duration-300 hover:border-white"
            >
